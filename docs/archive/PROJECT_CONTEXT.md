...
## Platform context
ContainerX is the platform; ElixoSense is the first workflow product built inside it. See `humandocs/CONTAINERX_CONTEXT.md` for the platform motive and north-star architecture.
...
- Kenya Commerce OS roadmap: `/Users/jaabirahmed/Documents/projects/WABAAA/elixosense-whatsapp/docs/inputs/kenya-commerce-os-roadmap.md`
- Reg/Platform obligations: `/Users/jaabirahmed/Documents/projects/WABAAA/humandocs/REG_PLATFORM_NOTES.md`
